...
export const EVENTOS: Evento[] = [
  // ===== FUTUROS =====
  {
    ...
    descricao: [
      ...
      'Vagas limitadas. Associados do Sindibes têm condições especiais. Certificado incluso.',
    ],
  ...
  },
  {
    ...
    local: 'Espaço de Eventos Sindibes',
    endereco: 'Av. Sacramento, 1472 - Martins, Uberlândia - MG',
  ...
  // ===== PASSADOS =====
  {
    ...
    descricao: [
      ...
      'Durante o evento, aconteceram workshops, demonstrações ao vivo e o Sindibes marcou presença apoiando os associados e captando novos filiados.',
  ...
  },
  {
    ...
    data: '2026-03-22',
    horario: '20h',
    local: 'Salão de Festas Sindibes',
    endereco: 'Uberlândia - MG',
    ...
    descricao: [
      'A Confraternização dos Associados reuniu a família Sindibes para celebrar as conquistas do ano.',
