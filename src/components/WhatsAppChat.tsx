...
export default function WhatsAppChat() {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-[42] w-[320px] animate-slide-in-right">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
        <div className="bg-[#075E54] p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-white font-semibold text-sm">Júlia</p>
        ...
        <div className="p-4 bg-[#ECE5DD] min-h-[120px]">
          <div className="bg-white rounded-lg rounded-tl-none p-3 shadow-sm max-w-[90%]">
            <p className="text-sm text-gray-800">
              Olá! 👋 Sou a Júlia, do {SITE.shortName}. Como posso ajudar você hoje?
            </p>
        ...
        <div className="p-3 border-t border-gray-100">
          <a
            href={whatsappUrl(`Olá Júlia! Vim pelo site da ${SITE.name} e gostaria de mais informações.`)}
            target="_blank"
